          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 ml-0 sm:ml-2 md:ml-4">
            ...
            <div className="flex flex-col space-y-6 sm:space-y-8 mt-6 lg:mt-0">
              ...
              <motion.div
                ...
                className="border border-gray-700 p-4 sm:p-6"
              >
                <h3 className="text-lg sm:text-xl font-medium mb-3 sm:mb-4">Resume</h3>
                <p className="text-gray-400 text-xs sm:text-sm mb-3">Download my resume to learn more about my experience and skills.</p>
                <a 
                  href="/assets/resume/Himanshu_Kumar_Resume.pdf" 
                  download="Himanshu_Kumar_Resume.pdf"
                  className="flex items-center space-x-2 text-gray-300 hover:text-[#c778dd] transition-colors text-sm sm:text-base border border-[#c778dd] px-4 py-2 hover:bg-[#c778dd]/10"
                >
                  <img src="/assets/icons/resume.svg" alt="Resume" className="w-5 h-5 sm:w-6 sm:h-6" />
